...
MODEL_NAME = "gemini-2.5-flash"  # أو "gemini-3-pro" حسب التسمية الفعلية في حسابك
...
2. **الهيكل المطلوب (ضروري اتباعو)**:
   - **مقدمة قوية (سطر واحد)**: جملة تشويقية ولا سؤال يثير الفضول (مثلاً: "أشنو هو السر فـ الهاتف لي كيعجب بزاف د الناس؟").
   ...
   - **التأثير على المستخدم المغربي (فقرة قصيرة)**:
     * كيفاش هاد الخبر غادي يغير حياة المغربي العادي؟ (مثلاً: "هاد الخاصية غادي تنفع الناس لي كيخدمو فالمكتبات").
   - **رأي شخصي (جملة أو جملتين)**: شارك توقعاتك ولا وجهة نظرك بطريقة ودية (مثلاً: "بالنسبة ليا، هاد الخطوة كاتبان واعدة بزاف").
   - **سؤال تفاعلي**: سؤال مفتوح يحفز المتابعين على التعليق (مثلاً: "واش كنتم تابعين هاد الخبر؟ شنو رأيكم فيه؟").
   - **الهاشتاجات**: سطر منفصل فيه 4-5 هاشتاجات متنوعة (بالدارجة أو بالإنجليزية) بحال #تكنولوجيا_المغرب #ذكاء_اصطناعي #أخبار_تقنية.

3. **الإيموجي (Emoji)**:
   - استخدم من 4 إلى 6 إيموجيات مناسبة وموزعة بذكاء فالنص.
   - اختار إيموجيات تقنية حديثة: 📱💻🚀🔥📊🔋📸🎮💡.
   - حط إيموجي فالعناوين الفرعية (بحال "🔹")، وبجانب الجمل المهمة، وقبل السؤال التفاعلي.
   - ما تكثرش الإيموجي بحيت يولي مبالغ فيه.

4. **الطول (جدا مهم)**:
   - **يجب** أن يكون المنشور بين **1500 و 2000 حرف** (بما فيه المسافات).
   - ما تتجاوزش 2000 حرف بأي حال من الأحوال.

5. **الجودة العامة**:
   - خلي النص سلس وسهل القراءة، ما يكونش فيو حشو ولا تكرار.
   - النص لازم يبانو إنسان كتبو، وليس روبوت.
   - استعمل علامات الترقيم بشكل صحيح.
